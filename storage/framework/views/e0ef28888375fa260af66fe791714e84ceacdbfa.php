    ...
    <!-- Waves Effect Css -->
    <link href="<?php echo e(asset('dashboard/plugins/node-waves/waves.css')); ?>" rel="stylesheet" />

    <!-- Animation Css -->
    <link href="<?php echo e(asset('dashboard/plugins/animate-css/animate.css')); ?>" rel="stylesheet" />
    ...
    <link href="<?php echo e(asset('dashboard/css/themes/all-themes.css')); ?>" rel="stylesheet" />




    <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.6.3/css/bootstrap-select.min.css" />
<?php /**PATH /Applications/MAMP/htdocs/homintec-redition/resources/views/partials/css.blade.php ENDPATH**/ ?>