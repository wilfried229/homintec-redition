...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    Surcharge <?php echo e($type? "annulé": ""); ?> /<?php echo e($site->nom); ?>


                   <a href="<?php echo e(route('surcharge-manuel.index')); ?>" style="float: right;" class="btn btn-info">Retour</a>
            ...
            <div class="body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                                ...
                                <form id="store-surcharge" action="<?php echo e(route('surcharge-manuel.store')); ?>" method="post" class="form" >
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="sites_id" value="<?php echo e($site->id); ?>">
                                            <input type="hidden" name="voies_id" value="<?php echo e($voie); ?>">
                                            <input type="hidden" name="type" value='<?php echo e($type? "ANNULE": "NORMAL"); ?>'>
...
<?php echo $__env->make('template-redition', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/homintec-redition/resources/views/dashboard/surcharges/create.blade.php ENDPATH**/ ?>