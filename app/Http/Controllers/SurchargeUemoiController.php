...
class SurchargeUemoiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $surchageUemoi = SurchargeUemoi::all();

        return response()->json($surchageUemoi, 200);
        //
    }
    ...
    public function store(Request $request)
    {
        ...
        $surchage->sens = $request->sens;
        $surchage->cabine = $request->cabine;
        $surchage->save();
