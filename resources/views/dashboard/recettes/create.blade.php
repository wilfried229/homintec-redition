                                ...
                                <form id="store-recette" action="{{route('recette.store')}}" method="post" class="form" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <input type="number" name="nombre_vehicule"  data-msg="Veuillez renseigner le nombre de vehecule  " id="nombre_vehicule" class="form-control" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            ...
                                            <input type="number" name="nombre_violation" data-msg="Veuillez renseigner le nombre de viloation " id="nombre_violation" class="form-control" required>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            ...
                                            <input type="number" name="nombre_exemptes" id="nombre_exemptes" data-msg="Veuillez renseigner le nombre exempter" class="form-control" required>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            ...
                                            <input  type="hidden" name="montant_coupant" id="montant_coupant" data-msg="Veuillez renseigner le nombre montant coupant"  class="form-control" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            ...
                                            <input type="number" name="montant_informatise" data-msg="Veuillez renseigner le montant informatise"  id="montant_informatise" class="form-control" required>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <label for="">Montant Percepteur</label>
                                            <input type="number" name="montant_percepteur"  data-msg="Veuillez renseigner le montant percepteur"  id="montant_percepteur" class="form-control" required>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
