                ...
                <div class="table-responsive">
                    <table id="listExport" class="table table-bordered ">
                        ...
                        <thead>
                            ...
                            <tr>
                                <th>DATE</th>
                                <th>SOMME MONTANT INFORMATISE</th>
                            </tr>
                            </thead>
                            ...
                            <tbody>
                                ...
                                @php
                                    $sommeTotales+=$mensuel['sommeMontantInformatiser']
                                @endphp
                                <tr>
                                 <td class="text-center" >{{ $mensuel['date_recettes'] }}</td>
                                <td class="text-center" >{{ number_format((float)$mensuel['sommeMontantInformatiser'] , 0, ' ', ' ') }}</td>
                                </tr>
