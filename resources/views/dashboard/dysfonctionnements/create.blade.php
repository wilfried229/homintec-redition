        ...
        <div class="card">
            <div class="header">
                <h2>
                    ...
                    <a href="{{route('dysfonctionnnemt.index')}}" style="float: right;" class="btn btn-info">Retour</a>
            ...
            <div class="body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form id="store-recette" action="{{route('dysfonctionnnemt.store')}}" method="post" class="form">
                            @csrf

                           @include('dashboard.dysfonctionnements.formulaire',['categorieDysfonctionnemts'=>$categorieDysfonctionnemts,'dysfonctionnement'=>$dysfonctionnnemt])
                            <br>
                        </form>
